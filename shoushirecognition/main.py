...
class Main:
    def __init__(self):
        ...
        self.camera = cv2.VideoCapture("D:\\videosave\\MV-CS050-10GC-PRO (DA1351773)\\Video_20240418110224186.avi")
    ...
    def Gesture_recognition(self):
        ...
        with open('index_finger_coordinates.csv', mode='r') as file:
    ...
    def process_coordinates(file_path):
        with open(file_path, mode='r',newline='') as file:
            ...
            if valid_frames > 0:
                ...
                print("----")
                print(y)
                dType.SetPTPCmd(api, 0, 1, 140, 0, 80, 0, isQueued=1)
                dType.SetPTPCmd(api, 0, 1, x, y, -34, 0, isQueued=1)
                print("----")
            else:
